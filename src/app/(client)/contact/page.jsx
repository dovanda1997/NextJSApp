...
//khai bao luoc do du lieu

const contactForm = z.object({
  info: z.object({
    email: z.string().trim().email("Email khong hop le"),
    tel: z.string().min(8, { message: "Tel must be at least 11 characters" }),
  }),
});
...
export default function Contact() {
  ...
  const onSubmit = (data) => {
    if (data.info.email && data.info.tel) {
      ...
      <div className="contact-Container">
        <Flex justifyContent={"space-between"}>
          <Flex
            ...
            alignItems={"center"}
          >
            <FaLocationDot className="icon-pageContact"></FaLocationDot>
            <Heading className="heading-contact">Our Location</Heading>
          ...
          <Flex
            ...
            alignItems={"center"}
          >
            <BsFillTelephoneFill className="icon-pageContact"></BsFillTelephoneFill>
            <Heading className="heading-contact">Phone Number</Heading>
            <p>234 567 893</p>
            <p>888-657-786</p>
          </Flex>
          <Flex
            ...
            alignItems={"center"}
          >
            <MdFax className="icon-pageContact"></MdFax>
            <Heading className="heading-contact">Fax</Heading>
            <p>1-234-678-543</p>
          </Flex>
          <Flex
            textAlign={"center"}
            ...
            alignItems={"center"}
          >
            <MdEmail className="icon-pageContact"></MdEmail>
            <Heading className="heading-contact">Email</Heading>
            <p>hello@gmail.com</p>
          </Flex>
        </Flex>
        <div className="form">
