...
export default function Login() {
  ...
  const onSubmit = (data) => {
    if (data.info.email && data.info.password) {
      setTimeout(() => {
  ...
  return (
    ...
    >
      <Stack spacing={8} mx={"auto"} maxW={"lg"} py={12} px={6}>
        <form>
          <Box
            style={{ boxShadow: "1px 2px 30px #bdb9b9" }}
          ...
          >
            ...
            <Stack spacing={4}>
              ...
              <FormControl>
                ...
                <ErrorMessage errors={errors} name="info.password" />
              </FormControl>
              ...
              <Stack spacing={8}>
                ...
                <Stack>
                  ...
                  <Flex justifyContent={"space-around"}>
                    <Box>
                      <BiLogoGooglePlusCircle color="red" fontSize={"32px"} />
                    </Box>
                    <Box>
                      <BiLogoFacebookCircle color="blue" fontSize={"32px"} />
                    </Box>
                    <Box>
                      <BiLogoGithub fontSize={"32px"} />
                    </Box>
                    <Box>
                      <BiLogoInstagramAlt color="pink" fontSize={"32px"} />
                    </Box>
                  </Flex>
                </Stack>
